        ...
        */
        ...
        switch (n) {
            case 1:
                ...
                Nave submarinoJ1 = new Nave("submarino",2);
                System.out.print("Ingrese coord iniciales para submarino: ");
                System.out.print("Fila: "); f1 = scanner.nextInt();System.out.println();
                System.out.print("Columna"); c1 = scanner.nextInt();
                tableroJugador1.colocarNave(submarinoJ1, f1, c1);
                tableroJugador1.mostrarTablero();
            
                System.out.println("Buque -> 4 casillas");
                Nave buqueJ1 = new Nave("Buque", 4);
                ...
                Nave portaavionesJ1 = new Nave("Portaaviones", 5);
                ...
                Nave AcorazadoJ1 = new Nave("Acorazado", 6);
                ...
                do {
                    ...
                    f1 = scanner.nextInt(); System.out.println();
                    System.out.print("Ingrese Columna de disparo: ");
                    c1 = scanner.nextInt();System.out.println();
